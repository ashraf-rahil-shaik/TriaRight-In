   ...
   ini_set('display_errors',1);
    ...
    switch($method) {
        ...
        case "POST":
            ...
            $sql = "INSERT INTO studentcipcreation(registrationType,pincode,studentName,emailId,phoneNo,alternatePhoneNo,gender,dateOfBirth,currentaddress,city,district,state,created_at) 
            ...
            $regtype="course Internship and Placement";
