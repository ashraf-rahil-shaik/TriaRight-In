   ...
   ini_set('display_errors',1);
    ...
    switch($method) {
        ...
        case "POST":
            ...
            $sql = "INSERT INTO studentccreation(registrationType,pincode,studentName,emailId,phoneNo,alternatePhoneNo,gender,dateOfBirth,currentaddress,city,district,state,created_at) 
